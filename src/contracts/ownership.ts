...
export const RESOURCE_OWNERS = {
  ...
  operator_command_audit: "operations",
  ...
  timeline_projections: "operations",
  step_replay_projections: "operations",
